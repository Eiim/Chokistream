...
public class Prop<T> {
	...
	public static final Prop<Boolean> VSYNC = new Prop<>("vsync", "VSync/HSync", false, Boolean.class);
	...
	public static final Prop<String> SEQUENCEDIR = new Prop<>("sequenceDir", "Output Directory", "out", String.class);
